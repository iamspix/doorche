    ...
    <div id="transaction-details">
        <table cellspacing="0" cellpadding="0">
            <tr>
                ...
                <th style="width: 240px;">Advance</th>
                <th style="width: 240px" class="last">Deposit</th>
            </tr>
            <tr>
                <td><?php echo $transactions['transaction_type'];?></td>
                <td><?php echo $transactions['advance'];?></td>
                <td class="last"><?php echo $transactions['security_deposit'];?></td>
            </tr>
        </table>
        <div id="total-cost">
